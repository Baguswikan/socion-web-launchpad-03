...
-- Create youtube_verifications table
...
-- Add trigger to update updated_at column for youtube_verifications table only
CREATE TRIGGER update_youtube_verifications_updated_at
  BEFORE UPDATE ON public.youtube_verifications
  FOR EACH ROW
